...
class HolidayCreateRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'date' => ['required', 'date'],
            'recurrence_type' => ['required', 'string', 'in:none,weekly,yearly'],
    ...
    public function messages(): array
    {
        return [
            ...
            'recurrence_type.required' => 'The recurrence type field is required.',
            ...
            'day_of_week.required' => 'The day of week field is required.',
            ...
            'month_day.required' => 'The month day field is required.',
            ...
            'is_approved.boolean' => 'The is approved field must be a boolean.',
