...
class PromotionCreateRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'discount_type' => ['required', 'string', 'max:255', 'in:' . implode(',', DiscountTypeEnum::values())],
            ...
            'dumpster_size_ids' => ['required', 'array'],
            'dumpster_size_ids.*' => [
                'required',
                'integer',
    ...
    public function messages(): array
    {
        return [
            ...
            'dumpster_size_ids.required' => 'Dumpster size ids is required',
            'dumpster_size_ids.array' => 'Dumpster size ids must be an array',
            'dumpster_size_ids.*.required' => 'Dumpster size id is required',
